...
def initialize_models():
    ...
    init_pmb_btc = joblib.load('PrimeModelBuyBTCEUR1.pkl')
    init_mmb_btc = joblib.load('MetaModelBuyBTCEUR1.pkl')
    init_pms_btc = joblib.load('PrimeModelSellBTCEUR1.pkl')
    init_mms_btc = joblib.load('MetaModelSellBTCEUR1.pkl')
    init_mr_btc = joblib.load('ModelRiskBTCEUR1.pkl')
    init_pmb_dot = joblib.load('PrimeModelBuyDOTEUR1.pkl')
    init_mmb_dot = joblib.load('MetaModelBuyDOTEUR1.pkl')
    init_pms_dot = joblib.load('PrimeModelSellDOTEUR1.pkl')
    init_mms_dot = joblib.load('MetaModelSellDOTEUR1.pkl')
    init_mr_dot = joblib.load('ModelRiskDOTEUR1.pkl')
